...
## 🔥 Update
- [12/26]🔥SliME is supported by [VLMEvalKit](https://github.com/open-compass/VLMEvalKit) and [LMMs-Eval](https://github.com/EvolvingLMMs-Lab/lmms-eval). Feel free to use it without hesitation!
