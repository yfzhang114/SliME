...
## 🔥 Update
- [012/26]🔥SliME is supported by [VLMEvalKit](https://github.com/open-compass/VLMEvalKit) and [LMMs-Eval](https://github.com/EvolvingLMMs-Lab/lmms-eval). Feel free to use it without hesitation!
- [10/26]🔥SliME-8B achieves better high-resolution understanding performance on [MME-RealWorld](https://mme-realworld.github.io/) compared to	Mini-Gemini and LLaVA-Next.
