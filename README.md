...
## 🔥 Update
- [07/16]🔥The SliME strategy demonstrates exceptional versatility, extending **seamlessly to video analysis**. Remarkably, even though the model has never been specifically trained on video data, it is capable of processing up to **8 frames**. In the Video-MME benchmark, the model surpasses numerous 7B/8B baselines that have undergone training on video datasets on [Video-MME benchmark](https://video-mme.github.io/home_page.html#leaderboard). See 
